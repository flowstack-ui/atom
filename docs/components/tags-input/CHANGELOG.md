...
- Preserve interactive descendants and composed trigger children without duplicate nesting.
- Keep existing atomic acceptance, JSON form values and keyboard contracts.
