...
Audited release commit: `2bb4d9044aede4319d669d8a34be743006c92ade`
...
- The package suite contains 520 passing tests. The complete local
  matrix also passes the playground build and Chromium/WebKit desktop and
  touch-profile suite with 64 browser tests, archive verification, and clean
...
packages. Current component changelogs use package versions through `0.20.10`;
...
The audited public package is `0.20.10`, published from the audited release
commit with npm provenance and a matching GitHub release. The npm `latest`
distribution tag resolves to this version. Post-release documentation and
test-harness cleanup does not change the runtime package or require another npm
version.
