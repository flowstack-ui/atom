...
test("namespace exports provide the long-term compound API", () => {
  ...
  assert.equal(typeof ContextMenu.CheckboxItem, "object");
  assert.equal(typeof ContextMenu.RadioGroup, "object");
  assert.equal(typeof ContextMenu.RadioItem, "object");
  assert.equal(typeof ContextMenu.Portal, "function");
  assert.equal(typeof ContextMenu.Arrow, "object");
  assert.equal(typeof ContextMenu.Label, "object");
  assert.equal(typeof ContextMenu.ItemIndicator, "object");
  ...
  assert.equal(typeof Menu.Portal, "function");
  assert.equal(typeof Menu.Arrow, "object");
  assert.equal(typeof Menubar.Content, "object");
  assert.equal(typeof Menubar.Item, "object");
  assert.equal(typeof Menubar.CheckboxItem, "object");
  assert.equal(typeof Menubar.RadioGroup, "object");
  assert.equal(typeof Menubar.RadioItem, "object");
