...
try {
  ...
  await writeFile(
    ...
    [
      'import { CheckboxGroup, Clipboard, Dialog, DragDrop, Link, List, MultiSelect, Reorder, Select, Portal, type ClipboardStatusValue, type ValidationBehavior } from "@flowstack-ui/atom";',
  ...
  await writeFile(
    ...
    [
      ...
      'import { Button, CheckboxGroup, Clipboard, Dialog, DragDrop, Link, MultiSelect, Portal, Reorder, Select } from "@flowstack-ui/atom";',
      'import { DragDrop as DragDropSubpath, DragDropRoot } from "@flowstack-ui/atom/drag-drop";',
      'import { Reorder as ReorderSubpath, ReorderRoot, reorderItems } from "@flowstack-ui/atom/reorder";',
