...
try {
  ...
  await writeFile(
    ...
    [
      'import { CheckboxGroup, Clipboard, Dialog, Link, List, MultiSelect, Select, Portal, type ClipboardStatusValue, type ValidationBehavior } from "@flowstack-ui/atom";',
      ...
      "void [dialogRoot, dialogContent, selectRoot, selectTrigger, multiSelectRoot, multiSelectTrigger, multiSelectSubpathRoot, checkboxGroupParent, checkboxGroupItemLabel, checkboxGroupItemDescription, linkRoot, linkSubpathRoot, clipboardTrigger, clipboardSubpathRoot, clipboardStatus, validationBehavior, formValidationBehavior, List, Portal];",
      "",
    ].join("\n"),
  );
  ...
  await writeFile(
    ...
    [
      ...
      'import { Button, CheckboxGroup, Clipboard, Dialog, Link, MultiSelect, Portal, Select } from "@flowstack-ui/atom";',
