...
try {
  ...
  await writeFile(
    ...
    [
      'import { CheckboxGroup, Dialog, Link, Select, Portal, type ValidationBehavior } from "@flowstack-ui/atom";',
      ...
      "void [dialogRoot, dialogContent, selectRoot, selectTrigger, checkboxGroupParent, checkboxGroupItemLabel, checkboxGroupItemDescription, linkRoot, linkSubpathRoot, validationBehavior, formValidationBehavior, Portal];",
      "",
    ].join("\n"),
  );
  ...
  await writeFile(
    ...
    [
      ...
      'import { Button, CheckboxGroup, Dialog, Link, Portal, Select } from "@flowstack-ui/atom";',
      'import { Link as LinkSubpath, LinkRoot } from "@flowstack-ui/atom/link";',
