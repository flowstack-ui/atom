...
try {
  ...
  await writeFile(
    ...
    [
      'import { Dialog, Select, Portal } from "@flowstack-ui/atom";',
      ...
      "void [dialogRoot, dialogContent, selectRoot, selectTrigger, Portal];",
      "",
    ].join("\n"),
  );
  ...
  await writeFile(
    ...
    [
      ...
      'import { Button, Dialog, Portal, Select } from "@flowstack-ui/atom";',
