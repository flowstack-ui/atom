...
function getSelectPartsSnapshot(
  ...
  const selectedItem = document.querySelector("[data-select-item][data-state='checked']");
  const rawItem = document.querySelector("[data-select-raw-item]");
  const itemText = document.querySelector("[data-select-item-text]");
  const itemIndicator = document.querySelector("[data-select-indicator][data-state='checked']");
  const uncheckedIndicator = document.querySelector("[data-select-indicator][data-state='unchecked']");
  const disabledItem = document.querySelector("[data-select-item][data-disabled]");
  const highlightedItem = document.querySelector("[data-select-item][data-highlighted]");
  const separator = document.querySelector("[data-select-separator]");
  const scrollUp = document.querySelector("[data-select-scroll-up]");
  const scrollDown = document.querySelector("[data-select-scroll-down]");
  const hiddenInput = document.querySelector<HTMLInputElement>("input[name='plan']");
  const canvas = document.querySelector(".canvas");
  const customContainer = document.querySelector("[data-select-custom-container]");
