    ...
    return [
      ...
      },
      {
        ...
        rows: [
          ...
          { label: "Live role", value: root?.getAttribute("role") ?? "none", category: "accessibility" },
      ...
      },
      {
        ...
        rows: [
          ...
          { label: "Role", value: viewport?.getAttribute("role") ?? "none", category: "accessibility" },
          { label: "Label", value: viewport?.getAttribute("aria-label") ?? "none", category: "accessibility" },
          { label: "Tab index", value: viewport?.getAttribute("tabindex") ?? "none", category: "accessibility" },
