...
The browser foundation runs existing desktop regressions in Chromium,
Firefox, WebKit and touch-specific smoke journeys in Android-Chromium and iPhone-WebKit
profiles. Emulated profiles are repeatable regression evidence, not physical
Android Chrome or iPhone Safari qualification.
