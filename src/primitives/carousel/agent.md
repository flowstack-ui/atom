...
- Verify controlled and uncontrolled selection, Previous/Next boundaries, loop, picker selection, native touch scrolling, LTR and RTL, and external value changes.
