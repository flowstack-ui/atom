...
- **MUST:** Include a persistent accessible pause control. Respect data-static for focus, reduced motion, completion and unavailable measurements; expose all originals with stationary native overflow.
